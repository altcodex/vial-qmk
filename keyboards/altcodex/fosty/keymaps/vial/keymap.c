...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_40_hhkb(
        TG_LAYOUT,KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, _______, KC_HOME,  KC_UP,   KC_END,  KC_DEL,
        _______,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, KC_PGUP, KC_LEFT, KC_RIGHT, _______,
        _______,  KC_F11,  KC_F12,  _______, _______, _______, _______, KC_PGDN, KC_DOWN,  _______, _______,
        _______,  _______, _______, _______, _______, _______
    ),
    [2] = LAYOUT_40_hhkb(
        _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,  _______,  KC_LBRC,  KC_RBRC, KC_BSLS, _______,
